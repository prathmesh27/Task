...
(function ($, $$) {
  var _ = $.extend(Mavo, {
    ...
    getClosestAttribute: function (element, attribute) {
      ...
      return (_element$closest$getA = (_element$closest = element.closest(`[${attribute}]`)) === null || _element$closest === void 0 ? void 0 : _element$closest.getAttribute(attribute)) !== null && _element$closest$getA !== void 0 ? _element$closest$getA : null;
    },
...
(async function ($, $$) {
  var _ = Mavo.Primitive = class Primitive extends Mavo.Node {
    ...
    edit(o = {}) {
      ...
      if ((_this$editor2 = this.editor) !== null && _this$editor2 !== void 0 && _this$editor2.matches("select")) {
...
(function ($, $$) {
  ...
  var _ = Mavo.Backend.register((_temp3 = _class6 = class Dropbox extends Mavo.Backend {
    constructor(url, o) {
      super(url, o);

      _defineProperty(this, "id", "Dropbox");

      _defineProperty(this, "oAuthParams", () => `&redirect_uri=${encodeURIComponent("https://auth.mavo.io")}&response_type=code`);
  ...
  }, _defineProperty(_class6, "apiDomain", "https://api.dropboxapi.com/2/"), _defineProperty(_class6, "oAuth", "https://www.dropbox.com/oauth2/authorize"), _defineProperty(_class6, "key", "2mx6061p054bpbp"), _defineProperty(_class6, "fixShareURL", url => {
    url = new URL(url, Mavo.base);
...
(function ($, $$) {
  ...
  let _ = Mavo.Backend.register((_temp4 = _class7 = class Github extends Mavo.Backend {
    constructor(url, o) {
      super(url, o);
    ...
    login(passive) {
      return this.oAuthenticate(passive).then(() => this.getUser()).catch(xhr => {
        ...
        if (this.user) {
          ...
          if (this.repo) {
            return this.request(`repos/${this.username}/${this.repo}`).then(repoInfo => {
      ...
      Object.defineProperties(ret, {
        "apiCall": {
          get() {
            ...
            let call = `repos/${this.username}/${this.repo}/${(_this$resources = this.resources) !== null && _this$resources !== void 0 ? _this$resources : "contents"}`;
  ...
  }, _defineProperty(_class7, "apiDomain", "https://api.github.com/"), _defineProperty(_class7, "oAuth", "https://github.com/login/oauth/authorize"), _defineProperty(_class7, "key", "7e08e016048000bc594e"), _defineProperty(_class7, "btoa", str => btoa(unescape(encodeURIComponent(str)))), _defineProperty(_class7, "atob", str => decodeURIComponent(escape(window.atob(str)))), _temp4));
})(Bliss, Bliss.$);
